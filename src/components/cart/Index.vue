<template>
    <div class="z-page z-cart">
        ...
        <div class="z-container">
            <blank v-if="!items.length" :define="true">
            ...
            <div class="cart-box" v-else>
                <div class="cart-item vux-1px-b">
                    <z-check>
                        <span slot="middle" class="zflex">
                            <icon icon="real-icon-dianpu" :vertical="false" class="gray"></icon>
                            <span class="cart-title">白沙维修店</span>
                        </span>
                ...
                <div class="cart-item vux-1px-b">
                    <z-check>
                        <div slot="middle" class="zflex">
                            <div class="service-img" :style="{backgroundImage: 'url('+require('../../assets/imgs/test.png')+')'}"></div>
                            <div class="service-name zflex1">
                                <div class="service-title">电热水器上门维修</div>
                                <div class="zflex">
                                    <span class="zflex1 red">￥30</span>
        ...
        <div class="service-bottom zflex vux-1px-t">
            ...
            <a href="javascript:;" class="buynow ripple" v-touch-ripple>立即购买</a>
        </div>
    </div>
</template>
<script>
    ...
    import NumberBox from '../service/Number.vue'
